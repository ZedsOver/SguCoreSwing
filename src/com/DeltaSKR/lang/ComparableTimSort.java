...
//    @SuppressWarnings("unchecked")
     ...
     * closer hint is to the result, the faster this method will run. @return
     * the int k, 0 <= k <= n such that a[b + k - 1] < key <= a[b + k],
     * pretending that a[b - 1] is minus infinity and a[b + n] is infinity. In
     * other words, key belongs at index b + k; or in other words, the first k
     * elements of a should precede key, and the last n - k should follow it.
     */
